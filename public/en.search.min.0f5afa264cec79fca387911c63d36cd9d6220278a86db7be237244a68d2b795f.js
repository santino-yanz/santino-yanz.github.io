...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6b4c6a72d57d5edf56f91bf76a3973a1a0b0d4f8a9792e3d3a007faa9767f278.js',function(){input.required=false;search();});}
